...
from utils import apply_model, evaluate, train_classification
from graphsage import GraphSAGE, Classification, UnsupervisedLoss


def arg_parse():
	parser = argparse.ArgumentParser(description='pytorch version of GraphSAGE')

	parser.add_argument('--dataSet', type=str, default='pubmed') # cora, pubmed
